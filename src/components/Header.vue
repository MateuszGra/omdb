<template>
  <header class="header">
    <img class="header__bg-title" src="../assets/movie.svg" />
...
.header {
  ...
  &__popcorn {
    ...
    left: -13.5%;
    bottom: -7%;
    animation: popcorn 0.5s 3s both linear;
  }
  ...
  &__content {
    ...
    align-items: center;
    padding-left: 8%;
    animation: show-right 1s 0.6s both linear;
  }
  ...
  &__title {
    ...
    font-size: 20rem;
    font-weight: 400;
    text-shadow: -0.5rem 0 0 #1ea0ef, 0.5rem 0 0 #f40048;
...
.search-bar {
  ...
  &__input {
    ...
    font-family: "Montserrat", sans-serif;
    font-size: 2.2rem;
    animation: show-input 1s 1.6s both linear;
    color: white;
  }
  &__btn {
    margin-left: 2rem;
    border-radius: 4.1rem;
    animation: show-btn 1s 2.6s both linear;
...
@media (max-width: 1200px) {
  .header {
    &__title {
      font-size: 14rem;
      text-shadow: -0.3rem 0 0 #1ea0ef, 0.3rem 0 0 #f40048;
      margin: 1rem 0;
    }
...
@media (max-width: 600px) {
  .header {
    ...
    &__title {
      font-size: 7rem;
      text-shadow: -0.1rem 0 0 #1ea0ef, 0.1rem 0 0 #f40048;
    }
